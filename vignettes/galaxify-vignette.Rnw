...
\newcommand{\galaxify}{\Rpackage{galaxify}}
...
The \galaxify{} package automates this process, pulling most of the necessary 
...
is in the \galaxify{} package under the name \Rcode{functionToGalaxify}:
...
<<datasets>>=
system.file("extdata", "a.tsv", package="galaxify")
system.file("extdata", "b.tsv", package="galaxify")
@
